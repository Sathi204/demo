...
public class MyResource {
    ...
    public Response createCookies() {
    	...
    	NewCookie cookie1 = new NewCookie("myStrCookie", "Sakthi");
        NewCookie cookie2 = new NewCookie("myDateCookie", "2022-08-10");
    ...
    public Response writeCookies() {
        NewCookie cookie1 = new NewCookie("degrees", "BTech");
        NewCookie cookie2 = new NewCookie("degrees", "MTech");
    ...
    @GET
    @Path("test10")
    public String readCookie7(@CookieParam("degrees") List<String> list) {
